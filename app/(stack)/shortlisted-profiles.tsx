...
//     { name: 'Priya Sharma', time: '1 hour ago', action: 'Added to shortlist' },
//     { name: 'Alex Thompson', time: '3 hours ago', action: 'Added to shortlist' },
//     { name: 'Neha Patel', time: '1 day ago', action: 'Added to shortlist' },
//     { name: 'Ryan Miller', time: '2 days ago', action: 'Added to shortlist' },
//     { name: 'Anita Singh', time: '3 days ago', action: 'Added to shortlist' },
//     { name: 'Kevin Brown', time: '4 days ago', action: 'Added to shortlist' },
//   ];
...
//         {/* Shortlisted Profiles List */}
//         <View style={styles.listContainer}>
//           <Text style={styles.sectionTitle}>Shortlisted Profiles</Text>
...
//             You have shortlisted {count} profiles. Take time to connect with them and send messages.
//           </Text>
//         </View>
//       </ScrollView>
//     </SafeAreaView>
